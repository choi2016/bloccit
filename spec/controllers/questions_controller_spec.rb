...
RSpec.describe QuestionsController, type: :controller do
  ...
  let(:my_question) { Question.create!(title: RandomData.random_question, body: RandomData.random_paragraph, resolved: "0") }
  ...
  describe "question create" do
    it "increases the number of question by 1" do
      expect{post :create, params:{question: {title: RandomData.random_question, body: RandomData.random_paragraph, resolved: "0"}}}.to change(Question,:count).by(1)
    end
    
    it "assigns the new question to @question" do
      post :create, params:{question: {title: RandomData.random_question, body: RandomData.random_paragraph, resolved: "0"}}
